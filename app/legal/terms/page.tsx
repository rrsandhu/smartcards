    ...
    <div className="container-site py-8 max-w-3xl">
      ...
      <div className="mt-6">
        ...
        <div className="space-y-6 text-gray-700 text-[15px] leading-relaxed">
          <p>By accessing SmartCardOffers, you agree to these terms. If you do not agree, please do not use this site.</p>

          <h2 className="text-xl font-bold text-gray-900 mt-8">Information Accuracy</h2>
          <p>SmartCardOffers strives to provide accurate, up-to-date information about Canadian credit cards and financial products. However, rates, fees, and offer details change frequently. Always verify current terms directly with the card issuer before making any financial decision.</p>
          ...
          <p>All content on SmartCardOffers — including articles, card reviews, images, and data — is the property of SmartCardOffers and may not be reproduced without permission.</p>

          <h2 className="text-xl font-bold text-gray-900 mt-8">Third-Party Links</h2>
          <p>Our site contains links to third-party websites, including credit card application pages. We are not responsible for the content, accuracy, or practices of those sites. When you click an affiliate link, you leave SmartCardOffers and become subject to the third party's terms and privacy policies.</p>

          <h2 className="text-xl font-bold text-gray-900 mt-8">Limitation of Liability</h2>
          <p>SmartCardOffers is not liable for any damages arising from your use of this site or reliance on information published here. Use this site at your own risk.</p>
          ...
          <p>Questions: <a href="mailto:hello@smartcardoffers.ca" className="text-navy-600 underline">hello@smartcardoffers.ca</a></p>
        </div>
      </div>
    </div>
  )
