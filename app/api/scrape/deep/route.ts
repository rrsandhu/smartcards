...
// POST /api/scrape/deep — deep Sunday scrape (~10 minutes).
// Runs: MintFlying (aggregator), PrinceOfTravel (curated — visits ~100 card pages).
// Triggered by Vercel cron at 07:00 UTC every Sunday.
