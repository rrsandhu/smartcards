...
// Secondary: Individual big bank pages

import * as cheerio from 'cheerio'
import { BaseMortgageScraper } from '@/lib/scraper-base'
import type { ScrapedMortgageRate } from '@/types/scraper'
...
export class BigBankMortgageScraper extends BaseMortgageScraper {
  ...
  private sources = [
    { lender: 'TD',         slug: 'td',         url: 'https://www.td.com/ca/en/personal-banking/products/mortgages/mortgage-rates/' },
    { lender: 'RBC',        slug: 'rbc',        url: 'https://www.rbcroyalbank.com/mortgages/mortgage-rates.html' },
    { lender: 'Scotiabank', slug: 'scotiabank', url: 'https://www.scotiabank.com/ca/en/personal/rates/mortgage-rates.html' },
    { lender: 'BMO',        slug: 'bmo',        url: 'https://www.bmo.com/en-ca/main/personal/mortgages/mortgage-rates/' },
    { lender: 'CIBC',       slug: 'cibc',       url: 'https://www.cibc.com/en/personal-banking/mortgages/rates.html' },
  ]
  ...
  private async scrapeLender(source: { lender: string; slug: string; url: string }): Promise<ScrapedMortgageRate[]> {
